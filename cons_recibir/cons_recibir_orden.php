...
$id = $_GET['id'];
//saco los conceptos
$qsql ="SELECT orcd_id, coru_nombre, orcd_precio, orcd_cantidad,orcd_recibido, orcd_restante
...
<td style='text-align:center;font-size: 8pt;background-color:<?php echo $bgcolor?>'><?php echo number_format(mysql_result($rsc, $j, 'orcd_precio'),2)?></td>
...
<td style=";background-color:<?php echo $bgcolor?>"><?php if($ores_id==1) {//solo lo muestro sino ha sido transformada?><a href="javascript:recibir(<?php echo $onchange1?>)"><img src="imagenes/down.png" style="width:20px;heigth:20px"></a><?php }?></td>
</tr>
<?
	$j++;
}
