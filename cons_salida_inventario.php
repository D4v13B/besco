...
{
	$('#result').load('cons_salida_inventario_procesar.php?id=' + $('#h_secuencia').val()
	,
	function()
	{
...
<?php echo autocompletar_filtro('inventario', 'construccion_obtener_inventario.php', 'inventario', 2, 'h_coru_id','','','','','buscar_disponible()')?>
