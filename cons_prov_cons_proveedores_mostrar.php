...
$f_copr_nombre=$_GET['f_copr_nombre'];

$where='';

if($f_copr_nombre!='' && $f_copr_nombre!='null') $where .="AND a.copr_nombre LIKE '%$f_copr_nombre%'";



$qsql ="select * from cons_proveedores a
WHERE 1=1 $where
ORDER BY copr_nombre";
