...
<table id='resultado' class="nicetable_th">
<thead class='thead-dark'>
<tr>
<th class=tabla_datos_titulo>Proyecto</th>
<th class=tabla_datos_titulo>Nivel</th>
...
$f_nive_nivel=$_GET['f_nive_nivel'];
$where='';
if($f_proy_id!='' && $f_proy_id!='null') $where .="AND a.proy_id IN ($f_proy_id)";
if($f_nive_nivel!='' && $f_nive_nivel!='null') $where .="AND a.nive_nivel LIKE '%$f_nive_nivel%'";

$qsql ="select * from cons_niveles a,proyectos b
WHERE 1=1 
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'nive_nivel'); ?></td>

            <td class=tabla_datos_iconos>
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'nive_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'nive_id'); ?>)' ;>
