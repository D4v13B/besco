...
<script>
$(function () {
        $("#i_ingr_fecha").datepicker({ dateFormat: 'yymmdd' });
		$("#f_desde").datepicker({ dateFormat: 'yymmdd' });
		$("#f_hasta").datepicker({ dateFormat: 'yymmdd' });
		$('#div_modificar').hide();
    });
...
{
		$("#result").load("cons_orden_compra/cons_orden_compra_enviar.php?id=" + id
					,
					function(data)
					{
						alert('O/C Enviada');
...
<tr>
<td colspan=6><div id=i_detalle style="overflow:auto;height:400px"></div></td>
</tr>
<tr>
<td colspan=2>
...
<!--EDITAR UBICACION-->
<div id='overlay3'></div>
<div id='modal3'><div id='content3'>
<input type=hidden id=h3_id>
<table>
<tr>
<td class='etiquetas'><div id="dv_ubicacion_actual"></div></td>
</tr>
<tr>
<td class='etiquetas'><div id="dv_ubicacion_disponible"></div></td>
</tr>
</table>
</div>
