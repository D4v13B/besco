...
<thead>
<tr>
<?php echo armar_encabezado_sorter("ID,Proveedor,Referencia,Fecha,Forma de Pago,Registrado por, Fecha de regristro,Monto")?>
</tr>
</thead>
<tbody>
<?php
...
$qsql ="SELECT prfp_id, fact_numero, prfp_monto, DATE_FORMAT(prfp_fecha, '%Y-%m-%d') fecha, fopa_nombre, copr_nombre,
