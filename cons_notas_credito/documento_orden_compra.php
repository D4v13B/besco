<?php 
$qsql ="SELECT DATE_FORMAT(orco_fecha, '%d/%m/%Y') fecha, copr_nombre proveedor, orco_numero,
(SELECT SUM(orcd_cantidad*orcd_precio) FROM cons_notas_credito_detalles WHERE orco_id='$id') monto
...
FROM cons_notas_credito_detalles a, construccion_rubros b
